...
export interface ApiOfertaOferta extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ofertas de trabajo publicadas por clientes';
    displayName: 'Oferta';
    pluralName: 'ofertas';
    singularName: 'oferta';
  };
  ...
  attributes: {
    ...
    paymentCompleted: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    status: Schema.Attribute.Enumeration<
      ['published', 'cancelled', 'accepted', 'completed']
    > &
      Schema.Attribute.Required &
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Rese\u00F1as de clientes sobre profesionales';
    displayName: 'Review';
    pluralName: 'reviews';
    singularName: 'review';
  };
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    offer: Schema.Attribute.Relation<'manyToOne', 'api::oferta.oferta'>;
    professional: Schema.Attribute.Relation<
      'manyToOne',
      'api::user-profile.user-profile'
    > &
...
export interface ApiUserProfileUserProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    professionalOffers: Schema.Attribute.Relation<
      'oneToMany',
      'api::oferta.oferta'
    >;
    profilePhoto: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    reviewsGiven: Schema.Attribute.Relation<'oneToMany', 'api::review.review'>;
